...
import EvidenceCard from '~/legacy/brand-geo/components/evidence/EvidenceCard.vue'
import { geoEvidenceAdapter } from '~/legacy/brand-geo/adapters/geoEvidenceAdapter'
