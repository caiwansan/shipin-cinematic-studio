...
import { ref } from 'vue'
import GeoProjectsPanel from '~/legacy/brand-geo-v2/GeoProjectsPanel.vue'
import GeoOverview from '~/legacy/brand-geo-v2/GeoOverview.vue'
import GeoTimeline from '~/legacy/brand-geo-v2/GeoTimeline.vue'
import GeoEvidence from '~/legacy/brand-geo-v2/GeoEvidence.vue'
import GeoPublish from '~/legacy/brand-geo-v2/GeoPublish.vue'
import GeoInsights from '~/legacy/brand-geo-v2/GeoInsights.vue'
import GeoInsightsPanel from '~/legacy/brand-geo-v2/GeoInsightsPanel.vue'
