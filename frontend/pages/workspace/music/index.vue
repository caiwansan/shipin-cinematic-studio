  ...
  <div class="page-wrapper">
    ...
    <header class="top-nav">
      <div class="nav-left">
        ...
        <span class="page-title">🎵 AI 音乐创作</span>
      </div>
      <div class="nav-right">
        <!-- 用户信息 -->
    ...
    <!-- 工作台主体（含 PipelineSidebar + MusicGenerationWorkspace + AssetSidebar） -->
    <main class="workspace-body">
      <MusicWorkspaceLayout />
    </main>
  </div>
</template>
...
import MusicWorkspaceLayout from '~/studio-v2/layout/MusicWorkspaceLayout.vue'
