...
.sp-sec-title { font-size: 14px; font-weight: 800; color: #e2e8f0; margin-bottom: 14px; }
...
.sp-help b { display: block; font-size: 12px; color: #e2e8f0; margin-bottom: 3px; }
...
.sp-shop-name { font-size: 12.5px; font-weight: 700; color: #e2e8f0; }
...
.sp-path-title { font-size: 13px; font-weight: 800; color: #e2e8f0; margin-bottom: 12px; }
