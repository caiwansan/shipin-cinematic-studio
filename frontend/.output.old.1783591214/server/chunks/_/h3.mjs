import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { NullProtoObj, removeRoute, createRouter, findRoute, addRoute, routeToRegExp } from 'rou3';
...
async function requireBasicAuth(event, opts) {
	...
	if (!authHeader) throw authFailed();
...
function toNodeHandler(app) {
	...
	return (toNodeHandler._toNodeHandler ??= () => {
		return process.getBuiltinModule("node:module").createRequire(globalThis._importMeta_.url)("srvx/node").toNodeHandler;
	})()(app.fetch);
}
...
export { getMethod as $, defineJsonRpcWebSocketHandler as A, defineLazyEventHandler as B, defineMiddleware as C, defineNodeHandler as D, defineNodeListener as E, defineNodeMiddleware as F, definePlugin as G, H3 as H, defineRoute as I, defineValidatedHandler as J, defineWebSocket as K, defineWebSocketHandler as L, deleteChunkedCookie as M, deleteCookie as N, dynamicEventHandler as O, eventHandler as P, fetchWithEvent as Q, freezeApp as R, fromNodeHandler as S, fromNodeMiddleware as T, fromWebHandler as U, getBodyStream as V, getChunkedCookie as W, getCookie as X, getEventContext as Y, getHeader as Z, getHeaders as _, H3Core as a, setChunkedCookie as a$, getProxyRequestHeaders as a0, getQuery as a1, getRequestFingerprint as a2, getRequestHeader as a3, getRequestHeaders as a4, getRequestHost as a5, getRequestIP as a6, getRequestPath as a7, getRequestProtocol as a8, getRequestURL as a9, onResponse as aA, parseCookies as aB, proxy as aC, proxyRequest as aD, readBody as aE, readFormData as aF, readFormDataBody as aG, readMultipartFormData as aH, readRawBody as aI, readValidatedBody as aJ, redirect as aK, redirectBack as aL, removeResponseHeader as aM, removeRoute$1 as aN, requestWithBaseURL as aO, requestWithURL as aP, requireBasicAuth as aQ, sanitizeStatusCode as aR, sanitizeStatusMessage as aS, sealSession as aT, sendIterable as aU, sendNoContent as aV, sendProxy as aW, sendRedirect as aX, sendStream as aY, sendWebResponse as aZ, serveStatic as a_, getRequestWebStream as aa, getResponseHeader as ab, getResponseHeaders as ac, getResponseStatus as ad, getResponseStatusText as ae, getRouterParam as af, getRouterParams as ag, getSession as ah, getValidatedCookies as ai, getValidatedQuery as aj, getValidatedRouterParams as ak, handleCacheHeaders as al, handleCors as am, html as an, isCorsOriginAllowed as ao, isError as ap, isEvent as aq, isHTTPEvent as ar, isMethod as as, isPreflightRequest as at, iterable as au, lazyEventHandler as av, mockEvent as aw, noContent as ax, onError as ay, onRequest as az, H3Error as b, setCookie as b0, setHeader as b1, setHeaders as b2, setResponseHeader as b3, setResponseHeaders as b4, setResponseStatus as b5, setServerTiming as b6, toEventHandler as b7, toMiddleware as b8, toNodeListener as b9, toRequest as ba, toResponse as bb, toWebHandler as bc, unsealSession as bd, updateSession as be, useBase as bf, useSession as bg, withBase as bh, withServerTiming as bi, writeEarlyHints as bj, H3Event as c, HTTPError as d, HTTPResponse as e, appendCorsHeaders as f, appendCorsPreflightHeaders as g, appendHeader as h, appendHeaders as i, appendResponseHeader as j, appendResponseHeaders as k, assertBodySize as l, assertMethod as m, basicAuth as n, bodyLimit as o, callMiddleware as p, clearResponseHeaders as q, clearSession as r, createApp as s, createError as t, createEventStream as u, createRouter$1 as v, defaultContentType as w, defineEventHandler as x, defineHandler as y, defineJsonRpcHandler as z };
