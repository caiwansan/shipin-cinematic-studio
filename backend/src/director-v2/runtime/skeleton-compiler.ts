...
export class SkeletonCompiler {
   ...
   */
  /**
   * @deprecated 已废弃——skeleton-compiler 应从 narrativeGateway 而不是直接读 process.env
   */
  private async defaultProvider(_systemPrompt: string, _userMsg: string): Promise<string> {
