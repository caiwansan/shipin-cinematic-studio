...
const envSchema = z.object({
  ...
  JWT_SECRET: z.string().min(32, 'JWT_SECRET 必须设置，长度至少 32 字符'),
  ...
  VOLCENGINE_LLM_MODEL: z.string().default('doubao-seed-2-1-pro-260628'),
  // 音乐生成
  ...
  PUBLIC_DOMAIN: z.string().default('https://aigc.fushtn.com'),
})
