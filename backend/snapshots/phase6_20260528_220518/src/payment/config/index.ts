...
export async function getWechatConfig(): Promise<WechatPayConfig | null> {
  ...
  try {
    ...
    return {
      ...
      notifyUrl: conf.notifyUrl || 'https://shipin.fushtn.com/api/payment/wechat/notify',
    }
  } catch {
    return null
  }
...
export async function getAlipayConfig(): Promise<AlipayConfig | null> {
  ...
  try {
    ...
    return {
      ...
      notifyUrl: conf.notifyUrl || 'https://shipin.fushtn.com/api/payment/alipay/notify',
      returnUrl: conf.returnUrl || 'https://shipin.fushtn.com/user/credits',
    }
  } catch {
    return null
  }
