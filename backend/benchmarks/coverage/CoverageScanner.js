...
exports.scanAllDatasets = scanAllDatasets;
...
function scanAllDatasets() {
    const datasets = readAllDatasets();
    const allCapIds = registry_js_1.CapabilityRegistry.listIds();
    const entries = new Map();
    for (const id of allCapIds) {
        const def = registry_js_1.CapabilityRegistry.byId(id);
        entries.set(id, {
            capability: id,
            primaryDatasets: [],
            secondaryDatasets: [],
