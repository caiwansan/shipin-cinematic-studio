/**
 * ============================================================
 *  Recruitment E2E Production Seed — Archived
 * ============================================================
 * 用途：
 ...
 *
 * 原说明（保留历史记录）：
 *   生成完整业务链: OrgMember → Organization → EnterpriseProfile
 *   → JobCompanyProfile → EnterpriseJobWorkspace → JobPosting
 *   → CandidateMatch → CareerProfile → RecruitmentConversation
 *   → InterviewSession → RecruitmentPipeline → Offer/Hire
 *   运行: npx tsx scripts/archive/recruitment/seed-recruitment-e2e-prod.ts
 */
