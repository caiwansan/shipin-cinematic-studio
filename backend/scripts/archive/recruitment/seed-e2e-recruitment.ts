/**
 * ============================================================
 *  Minimal E2E Recruitment Seed — Archived
 * ============================================================
 * 用途：
 ...
 *
 * 原说明：
 *   Task 01: 最小化 E2E 招聘测试数据
 *   Chain: CareerProfile → CandidateMatch → InterviewSession
 *   运行: npx tsx scripts/archive/recruitment/seed-e2e-recruitment.ts
 */
