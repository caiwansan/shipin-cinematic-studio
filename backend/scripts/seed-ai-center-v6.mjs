...
const MODELS = [
  ...
  { p: 'midjourney', code: 'midjourney-v7', name: 'Midjourney V7', ver: 'V7', types: ['image'], ctx: null, in: null, out: null, cur: 'USD', cap: { quality: 97, speed: 88, cost: 80, chinese: 80 }, ds: '订阅制（$10-$120/月），待运营验证', docs: 'https://docs.midjourney.com', api: '', pending: true, sort: 1, desc: '全球文生图审美标杆：订阅制' },
  ...
  { p: 'runway', code: 'runway-gen4', name: 'Runway Gen-4', ver: 'Gen-4', types: ['video'], ctx: null, in: null, out: null, cur: 'USD', cap: { quality: 93, speed: 84, cost: 84, chinese: 82 }, ds: '订阅制（$12-$76/月），待运营验证', docs: 'https://runwayml.com', api: '', pending: true, sort: 1, desc: '好莱坞级视频生成：电影质感控制力强' },
