...
async function main() {
  ...
  console.log(`✅ ${createdClaims.length * pubChannels.length} publishing records created`)
  ...
  console.log(`  Records:         ${createdClaims.length * 3}`)
  console.log(`  Channels:        markdown, html_preview, schema_jsonld`)
  console.log('═══════════════════════════════════════════')
