/**
 * GEO Design Tokens — Centralized design system for GEO workspace UI.
 *
 * All visual styling values come from here. No inline color values
 * in any other file — import and use these tokens instead.
 *
 * @package workspace/geo/tokens
 */
